https://www.kaggle.com/competitions/gen-ai-intensive-course-capstone-2025q1/overview
...
The Capstone Project is open from Friday April 4, 2025 Pacific Time and ends Sunday April 20, 2025. See the section [**Submission Instructions**](#submission-instructions) below for more information.
...
You must demonstrate what you've learned in this course by applying it to a use case of your choosing in a Kaggle Notebook. You must demonstrate in your code at least three (3) of the generative AI capabilities you learned in this course (see the [**Gen AI capabilities**](#gen-ai-capabilities) section below).
...
*   **minimum three (3) gen AI capabilities used in the notebook**: see list of capabilities in [Gen AI Capabilities](#gen-ai-capabilities)
...
**Competition opens: Fri April 4 at 9:00 AM Pacific Time** **Submission deadline: Sun April 20 at 11:59 PM Pacific Time**

### Making your submission

# Complete the [➡️ Google Form here ⬅️](https://forms.gle/VWKMRqvLS3DaDeeP7) to submit your capstone project
...
Winners will be announced: **Fri April 25 at 9:00 AM Pacific Time** The winners (top 10 teams) will be shared here in this competition page (keep an eye on the [Discussion forum](https://www.kaggle.com/competitions/gen-ai-intensive-course-capstone-2025q1/discussion)) and on social media.  
The winning teams will be given Kaggle swag and their work will be highlighted by Kaggle and Google social media.

### Citation

Addison Howard, Brenda Flynn, Kinjal Parekh, Myles O'Neill, Nate Keating, Polong Lin, and Ray Harvey. Gen AI Intensive Course Capstone 2025Q1. https://kaggle.com/competitions/gen-ai-intensive-course-capstone-2025q1, 2025. Kaggle.
