...
a. [] Listen to the [summary podcast episode](https://www.youtube.com/watch?v=FMcExVE15a4) for this unit, created by [NotebookLM](https://notebooklm.google.com/).  
 
b. [] To complement the podcast, read the [“Context Engineering: Sessions & Memory whitepaper”](https://www.kaggle.com/whitepaper-context-engineering-sessions-and-memory).  
